...
namespace Pixelplacement
{
	public class Client : NetworkDiscovery
	{
		...
		public QosType qualityOfService = QosType.Reliable;
		#endregion
		...
		//we frame skip here to allow any externally set configs to be utilized:
		...
		public static void UnregisterHandler(short msgType, NetworkMessageDelegate handler)
		{
